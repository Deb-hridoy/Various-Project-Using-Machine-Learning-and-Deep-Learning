...
```bash
git clone https://github.com/Deb-hridoy/Various-Project-Using-Machine-Learning-and-Deep-Learning.git
```

Move into the project directory:

```bash
cd Various-Project-Using-Machine-Learning-and-Deep-Learning
```
...
```bash
python Business_ML/customer_churn_prediction.py
```

Or:

```bash
python CNN_Project/cat_or_dogs_image_prediction.py
```
